...
int main() {
    ...
    GameState gs{ Map(),                                     // game map
                  {3.456, 2.345, 1.523, M_PI/3., 0, 0, 1},   // player
                  { {3.523, 3.812, 2, 0, 0.3, M_PI/2.},               // monsters lists
                    {1.834, 8.765, 0, 0, 0.3, M_PI/2.},
                    {5.323, 5.365, 1, 0, 0.3, M_PI/2.},
                    {14.32, 13.36, 3, 0, 0.3, M_PI/2.},
                    {4.123, 10.76, 1, 0, 0.3, M_PI/2.} },
